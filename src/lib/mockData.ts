...
export const MOCK_TASKS: Task[] = [
  ...
  },
  {
    ...
    description: 'Criar schema e relacionamentos do sistema ERP',
    status: 'in_progress',
    priority: 'high',
    createdBy: 2,
    createdByName: 'Pedro Corgnatti',
    ...
    progress: 75,
    subtasks: [
      { id: 16, taskId: 5, description: 'Definir entidades', isCompleted: true },
      { id: 17, taskId: 5, description: 'Criar diagrama ER', isCompleted: true },
      { id: 18, taskId: 5, description: 'Implementar migrations', isCompleted: true },
      { id: 19, taskId: 5, description: 'Documentar schema', isCompleted: false }
    ],
  ...
  },
  {
    id: 6,
    projectId: 2,
    title: 'Interface de Gestão de Estoque',
    description: 'Desenvolver telas de controle de estoque',
    status: 'review',
    priority: 'medium',
    createdBy: 3,
    createdByName: 'Nicholas Fernandes',
    ...
    progress: 90,
    subtasks: [
      { id: 20, taskId: 6, description: 'Listagem de produtos', isCompleted: true },
      { id: 21, taskId: 6, description: 'Entrada de estoque', isCompleted: true },
      { id: 22, taskId: 6, description: 'Saída de estoque', isCompleted: true },
      { id: 23, taskId: 6, description: 'Relatórios', isCompleted: true },
      { id: 24, taskId: 6, description: 'Code review', isCompleted: false }
    ],
